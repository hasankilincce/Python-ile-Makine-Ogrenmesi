...
"""
# Encoding kullanacağız: Kategorik => Numeric
...
# Veri kümelerinin Eğitim ve Test diye bölünmesi
from sklearn.model_selection import train_test_split

x_train, x_test, y_train, y_test = train_test_split(s, sonuc3, test_size=0.33, random_state=42) # 66-33 oranında eğitim ve test olarak bölmek
